...
final class DataManager {
    ...
    let names = [
        "Kevin", "Adam", "Ben", "Alexander", "Andrew", "Samuel", "Fred",
        "Martin", "Bill", "Brad", "Steve", "Douglas","John", "Aaron", "Tim",
        "Ted", "Steven", "Sharon", "Nicola", "Allan", "Bruce", "Carl"
    ]
    let surnames = [
        "Adamson", "Aldridge", "Johnson", "Evans", "Davies", "Wilson", "Parson",
        "Smith", "Brown", "Walker", "Lewis", "King", "Smith", "Dow", "Isaacson",
        "Pennyworth", "Jankin", "Butler", "Black", "Robertson", "Murphy", "Williams"
    ]
